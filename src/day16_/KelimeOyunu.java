...
public class KelimeOyunu {
	...
	public static void main(String[] args) {{
		...
		/*
		 * /* Iki kisinin oynayacagi bir kelime oyunu uretelim Kurallar 1.Adım-
		 * Baslangicta 1.oyuncudan bir kelime girmesini isteyin ve kelimeyi yazdirin
		 *
		 * 2.Adım- 1.oyuncu kelimeyi girince 2.oyuncuya kelimeyi kabul edip etmedigini
		 ...
		 * bitirin.
		 *
		 * 3.Adım- 2. oyuncuya oyuna devam etmek isteyip istemedigini sorun * devam
