...
public class C02_StringBuilder2 {
	...
	public static void main(String[] args) {
		...
		// istenen index' istenen karakteri ve karakterleri eklemek -->
		// obj.insert(index,obj) : insert metodo parametre olarak sadece char almz obj
		// alabilir
		sb1.insert(2, "r");
		...
		// istenen index deki characterin yerine birden fazla character eklemek -->
		...
		// ama atanacak string kısa atanacak index uzun olursa kalan index'teki
		// karakterleri siler
		 ...
		 * 2:eklenecek stringin baslangic indexi--> dahil 4:eklenecek stringin bitis
		 * indexi --> haric.
		 */
